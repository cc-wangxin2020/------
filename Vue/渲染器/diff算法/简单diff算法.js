/**
 * diff算法：  
 *    对于新旧vnode子节点都为数组的情况：需要采用diff算法进行渲染以减少dom操作次数和性能开销
 *    作用：减少性能开销  
 * 原理：
 *    1. 通过比较新旧vnode子节点长度，取两者长度最小值
 * ·  2. 新vnode子节点长度小于旧vnode子节点长度，直接挂载多出的子节点
 *    3. 新vnode子节点长度大于旧vnode子节点长度，直接卸载多出的旧子节点
 * 
 */
